...
export default function VitrineProdutos({
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-3 sm:gap-6 xl:gap-7">
      {produtos.length === 0 ? (
          ...
          return (
            ...
            >
              ...
              <div className="p-3 sm:p-5 flex-1 flex flex-col">
                ...
                <div
                  className="flex items-center justify-between mt-auto pt-2 border-t border-stone-50"
                  ...
                  {quantidade > 0 ? (
                    <div className="flex items-center gap-1 sm:gap-2 bg-stone-100 rounded-full px-1.5 py-1 sm:px-2 sm:py-1 border border-stone-200">
                      <button
                        ...
                        className="text-stone-500 hover:text-rose-600 active:scale-90 p-1"
                      >
                        <Minus className="w-3 h-3" />
                      </button>

                      <span className="text-xs font-bold text-stone-800 w-3 sm:w-4 text-center">
                        {quantidade}
                      </span>

                      <button
                        onClick={() => atualizarQuantidade(produto.id, 1)}
                        className="text-stone-500 hover:text-green-600 active:scale-90 p-1"
                      >
